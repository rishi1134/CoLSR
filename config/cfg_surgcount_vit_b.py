...
set_cost_bbox = 10.0
set_cost_giou = 0.0
set_cost_neigh = 100.0
cls_loss_coef = 1.0
bbox_loss_coef = 10.0 
giou_loss_coef = 0.0
neigh_loss_coef = 100.0
enc_loss_coef = 1.0
...
text_threshold = 0
use_coco_eval = False
label_list = ['circular scissor handle']
val_label_list = ['circular scissor handle']
use_prompt_tuning = True
num_learnable_prompt = 64 if use_prompt_tuning else None
